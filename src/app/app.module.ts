...
import { DownloadTemplateComponent } from './shared/components/download-template.component';
import { AiFeedbackComponent } from './shared/components/ai-feedback.component';
import { StudentProgressComponent } from './shared/components/student-progress.component';
import { CohortUploadComponent } from './shared/components/cohort-upload.component';
import { SkillsGapComponent } from './shared/components/skills-gap.component';
...
@NgModule({
  declarations: [
    ...
    LoadingSpinnerComponent, ScoreBadgeComponent,
    DownloadTemplateComponent, AiFeedbackComponent, StudentProgressComponent, CohortUploadComponent, SkillsGapComponent
  ],
